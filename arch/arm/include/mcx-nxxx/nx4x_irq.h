/****************************************************************************
 * arch/arm/include/mcx-nxxx/nx4x_irq.h
 *
 ...
 ****************************************************************************/
 ...
 #ifndef ARCH_ARM_INCLUDE_MCX_NXXX_NX4X_IRQ_H
 #define ARCH_ARM_INCLUDE_MCX_NXXX_NX4X_IRQ_H
 ...
 #define NXXX_IRQ_LP_FLEXCOMM8           (NXXX_IRQ_EXTINT + 43)                /**< LP_FLEXCOMM8 (NXXX_IRQ_EXTINT + LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit interrupt) */
 #define NXXX_IRQ_LP_FLEXCOMM9           (NXXX_IRQ_EXTINT + 44)                /**< LP_FLEXCOMM9 (NXXX_IRQ_EXTINT + LPSPI interrupt or LPI2C interrupt or LPUART Receive/Transmit interrupt) */
 ...
 #define NXXX_IRQ_USBFS0                 (NXXX_IRQ_EXTINT + 50)                /**< Universal Serial Bus - Full Speed interrupt */
 ...
 #define NXXX_IRQ_MAILBOX0               (NXXX_IRQ_EXTINT + 54)                /**< Inter-CPU Mailbox interrupt0 for CPU0 Inter-CPU Mailbox interrupt1 for CPU1 */
 ...
 #define NXXX_IRQ_PLU0                   (NXXX_IRQ_EXTINT + 70)                /**< Programmable Logic Unit interrupt */
 ...
 #define NXXX_IRQ_POWERQUAD0             (NXXX_IRQ_EXTINT + 76)                /**< PowerQuad interrupt */
 ...
 #define NXXX_IRQ_TSI0                   (NXXX_IRQ_EXTINT + 101)               /**< TSI0 End of Scan interrup */
 #define NXXX_IRQ_TSI1                   (NXXX_IRQ_EXTINT + 102)               /**< TSI1 End of Scan interrup */
 #define NXXX_IRQ_EMVSIM0                (NXXX_IRQ_EXTINT + 103)               /**< EMVSIM0 interrup */
 #define NXXX_IRQ_EMVSIM1                (NXXX_IRQ_EXTINT + 104)               /**< EMVSIM1 interrup */
 #define NXXX_IRQ_FLEXIO                 (NXXX_IRQ_EXTINT + 105)               /**< Flexible Input/Output interrupt */
 #define NXXX_IRQ_DAC0                   (NXXX_IRQ_EXTINT + 106)               /**< 12-bit Digital-to-Analog Converter 0 - General Purpose interrupt */
 #define NXXX_IRQ_DAC1                   (NXXX_IRQ_EXTINT + 107)               /**< 12-bit Digital-to-Analog Converter 1 - General Purpose interrupt */
 ...
 #define NXXX_IRQ_HSCMP2                 (NXXX_IRQ_EXTINT + 111)               /**< High-Speed comparator2 interruptt */
 ...
 #define NXXX_IRQ_ENET0_QOS              (NXXX_IRQ_EXTINT + 139)               /**< Ethernet QoS interrupt */
 #define NXXX_IRQ_ENET0_QOS_POW          (NXXX_IRQ_EXTINT + 140)               /**< Ethernet QoS power management interrupt */
 #define NXXX_IRQ_ENET0_QOS_MAC          (NXXX_IRQ_EXTINT + 141)               /**< Ethernet QoS MAC LPI interrupt */
 #define NXXX_IRQ_SINC0                  (NXXX_IRQ_EXTINT + 142)               /**< SINC Filter interrup */
 ...
 #define NXXX_IRQ_CTI0                   (NXXX_IRQ_EXTINT + 155)               /**< Cross Trigger Interface (CTI) interrupt */
 ...
 #endif /* ARCH_ARM_INCLUDE_MCX_NXXX_NX4X_IRQ_H */
