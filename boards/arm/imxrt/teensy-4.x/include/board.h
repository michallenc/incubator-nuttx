...
#define GPIO_FLEXPWM1_MOD3_A (IOMUX_PWM_DEFAULT) /* GPIO_EMC_06 */
#define GPIO_FLEXPWM3_MOD4_A (IOMUX_PWM_DEFAULT) /* GPIO_EMC_06 */
...
#define GPIO_FLEXPWM2_MOD4_A (IOMUX_PWM_DEFAULT)                        /* GPIO_B1_02 */
#define GPIO_FLEXPWM1_MOD4_A (GPIO_FLEXPWM1_PWMA03_5|IOMUX_PWM_DEFAULT) /* GPIO_B1_00 */
#define GPIO_FLEXPWM4_MOD3_A (IOMUX_PWM_DEFAULT) /* GPIO_EMC_06 */
