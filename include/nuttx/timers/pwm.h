 ...
 *  ioctl argument:  None
 *
 * PWMIOC_FAULTS_FETCH_AND_CLEAR - Clear fault inputs. This command will
 *  clear fault inputs and re-enable PWM output.
 *
 *  ioctl argument:  An unsigned long bitmask of fault inputs to be cleared.
 */
